...
int main(int argc, char **argv)
{
	...
	s1.Read_LQTS1_p("LQTS1_data.txt", 18);
	...
	char fn[80];
    strcpy(fn, "v2_2.180922.set4.s18.");
	std::stringstream ss;
	ss << iRand2;
	...
	// State Preservation
	fb2.open("v2_2.180922.set4.s18.StochData.txt", std::ios::out);
	fb3.open("v2_2.180922.set4.s18.FRUsData.txt", std::ios::out);

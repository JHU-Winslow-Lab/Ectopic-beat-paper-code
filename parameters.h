...
// #define NNCXs_per_cleft 56 //58 //38 //77 //115 //138 161 115 //32 //64 //96 ERROR!!! new change
#define NRyRs_per_cleft 48 
#define Max_LCCs_per_cleft 8//8 //7 //8 //10
#define NIto2_per_cleft 5
#define Nstates_RyR 2
#define Nstates_Ito2 2
#define Nstates_NaCa 16
